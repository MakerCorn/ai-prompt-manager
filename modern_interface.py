...
class ModernInterface:
    ...
    def create_login_section():
        ...
        with gr.Column(elem_classes=["login-container"]) as login_section:
            ...
            # Login tabs
            with UIComponents.create_card("") as login_card:
                with gr.Tabs(elem_classes=["login-tabs"]):
                    # Email login tab
                    with gr.TabItem(f"📧 {t('auth.login')}", elem_classes=["login-tab"]):
        ...
        return login_section, login_email, login_password, login_subdomain, login_btn, login_message, sso_subdomain, sso_btn, sso_message, language_selector
    ...
    def create_prompts_tab():
        ...
        def create_prompt_form():
            with UIComponents.create_card(t("prompt.add")):
                ...
                action_bar = UIComponents.create_action_bar(actions)
                
                prompt_status = UIComponents.create_status_display("status.info")
            
            return prompt_name, prompt_title, prompt_category, prompt_content, prompt_tags, is_enhancement_prompt, prompt_status
        ...
        def create_quick_actions():
            ...
            return edit_prompt_name, load_edit_btn, delete_prompt_name, delete_btn, edit_status
    ...
    def create_calculator_tab():
        ...
        return calc_model, max_completion_tokens, calculate_tokens_btn, token_calc_status
    ...
    def create_optimization_section():
        ...
        with UIComponents.create_card(t("opt.title")):
            ...
            with gr.Column(visible=False, elem_classes=["optimization-results"]) as optimization_results:
                with gr.Row():
        ...
        return (optimization_context, target_model, optimize_btn, langwatch_status,
                optimization_results, optimization_score, optimization_suggestions,
                optimized_prompt_display, optimization_reasoning, optimization_status)
    ...
    def create_settings_tab():
        ...
        return language_selector, service_type, api_endpoint, api_key, model_name, save_config_btn, config_status
...
def create_modern_ui():
    ...
    with create_modern_interface() as app:
        ...
        (login_section, login_email, login_password, login_subdomain, 
         login_btn, login_message, sso_subdomain, sso_btn, 
         sso_message, language_selector) = login_components
