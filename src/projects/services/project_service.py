...
from ...core.base.service_base import TenantAwareService, ServiceResult
...
class ProjectService(TenantAwareService):
    ...
    def create_project(self, project_data: Dict[str, Any]) -> ServiceResult[Project]:
        ...
        try:
            ...
            self.validate_field_types(project_data, {
                "name": str,
                "title": str,
                "description": str,
                "project_type": str,
            ...
            self.log_operation(
                ...
                user_id=self.current_user_id,
                tenant_id=self.current_tenant_id,
                details={"project_id": saved_project.id, "project_name": saved_project.name}
            )
    ...
    def update_project(self, project_id: int, update_data: Dict[str, Any]) -> ServiceResult[Project]:
        """
        ...
        try:
            ...
            self.log_operation(
                ...
                user_id=self.current_user_id,
                tenant_id=self.current_tenant_id,
                details={"project_id": project_id, "updated_fields": list(sanitized_data.keys())}
            )
    ...
    def get_user_projects(self, include_shared: bool = True) -> ServiceResult[List[Project]]:
        """
        ...
        try:
            ...
            if include_shared:
                projects = self.project_repo.find_accessible_projects(self.current_user_id)
            else:
    ...
    def add_project_member(self, project_id: int, user_id: str, role: str = "member") -> ServiceResult[ProjectMember]:
        """
        ...
        try:
            ...
            try:
                ...
                return ServiceResult.error_result(
                    f"Invalid role: {role}",
                    error_code="INVALID_MEMBER_ROLE"
                )
    ...
    def remove_project_member(self, project_id: int, user_id: str) -> ServiceResult[bool]:
        """
    ...
    def get_project_members(self, project_id: int) -> ServiceResult[List[ProjectMember]]:
        """
    ...
    def add_prompt_to_project(
        ...
        try:
            ...
            existing_association = self.prompt_repo.find_association(project_id, prompt_id)
            ...
            self.log_operation(
                ...
                user_id=self.current_user_id,
                tenant_id=self.current_tenant_id,
                details={"project_id": project_id, "prompt_id": prompt_id, "sequence_order": sequence_order}
            )
    ...
    def remove_prompt_from_project(self, project_id: int, prompt_id: int) -> ServiceResult[bool]:
        """
    ...
    def get_project_prompts(self, project_id: int) -> ServiceResult[List[ProjectPrompt]]:
        """
    ...
    def add_rule_to_project(
        ...
        try:
            ...
            self.log_operation(
                ...
                user_id=self.current_user_id,
                tenant_id=self.current_tenant_id,
                details={"project_id": project_id, "rule_id": rule_id, "rule_set_name": rule_set_name}
            )
    ...
    def remove_rule_from_project(self, project_id: int, rule_id: int) -> ServiceResult[bool]:
        """
    ...
    def get_project_versions(self, project_id: int) -> ServiceResult[List[ProjectVersion]]:
        """
    ...
    def get_user_role_in_project(self, project_id: int, user_id: str) -> Optional[ProjectMemberRole]:
