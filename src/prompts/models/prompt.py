...
class Prompt:
    ...
    def _validate_fields(self) -> None:
        ...
        if not re.match(r'^[a-zA-Z0-9\s\-_]+$', self.name):
            raise ValueError("Prompt name can only contain letters, numbers, spaces, hyphens, and underscores")
    ...
    @classmethod
    def from_legacy_dict(cls, data: Dict[str, Any], tenant_id: str, user_id: str) -> 'Prompt':
        """
    ...
    def clone(self, new_name: Optional[str] = None, new_tenant_id: Optional[str] = None) -> 'Prompt':
        """
    ...
    def __repr__(self) -> str:
        ...
        return (f"Prompt(id={self.id}, name={self.name}, title={self.title}, "
