...
class PromptService(BaseService):
    ...
    def update_prompt(
        ...
        try:
            ...
            if original_name.strip() != new_name.strip():
                if self.repository.name_exists(new_name.strip(), exclude_id=existing_prompt.id):
                    return ServiceResult(
                        success=False,
    ...
    def get_recent_prompts(self, tenant_id: str, limit: int = 10) -> ServiceResult[List[Prompt]]:
        """
    ...
    def _validate_prompt_data(self, name: str, title: str, content: str) -> ServiceResult[bool]:
        """
