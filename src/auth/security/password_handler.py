...
from ...core.exceptions.base import AuthenticationException, ConfigurationException
...
class PasswordHandler:
    ...
    def __init__(self, algorithm: Optional[str] = None):
        ...
        self.logger.info(f"Password handler initialized with {self.algorithm} algorithm")
    ...
    def _select_algorithm(self, preferred: Optional[str] = None) -> str:
        ...
        if preferred:
            if preferred == 'argon2' and ARGON2_AVAILABLE:
                ...
                self.logger.warning(f"Preferred algorithm '{preferred}' not available, falling back")
        ...
        if ARGON2_AVAILABLE:
            ...
            self.logger.warning("Modern password hashing libraries not available, using PBKDF2")
            return 'pbkdf2'
    ...
    def verify_password(self, password: str, hashed_password: str, salt_or_metadata: str) -> bool:
        """
    ...
    def get_algorithm_info(self) -> dict:
        ...
        return {
            ...
            'recommended': 'argon2' if ARGON2_AVAILABLE else 'bcrypt' if BCRYPT_AVAILABLE else 'pbkdf2'
        }