...
class TestAPIEndpoints:
    ...
    def test_api_manager_initialization(self, temp_db):
        ...
        with patch("api_endpoints.APITokenManager"), patch("api_endpoints.AuthManager"):
    ...
    def test_get_current_user_valid_token(
        ...
        # Setup mocks
        mock_managers["token_manager"].validate_api_token.return_value = (
            True,
            sample_user.id,
        ...
        response = test_client.get(
            "/api/user/info", headers={"Authorization": f"Bearer {valid_token}"}
        )
    ...
    def test_get_current_user_invalid_token(self, test_client, mock_managers):
        ...
        response = test_client.get(
            "/api/user/info", headers={"Authorization": "Bearer invalid-token"}
        )

        assert response.status_code == 401

    def test_get_current_user_token_valid_user_not_found(
        self, test_client, mock_managers, valid_token, sample_user
    ):
        ...
        mock_managers["auth_manager"].get_tenant_users.return_value = (
            []
        )  # No users found
    ...
    def test_list_prompts_basic(
        ...
        response = test_client.get(
            "/api/prompts", headers={"Authorization": f"Bearer {valid_token}"}
        )
    ...
    def test_list_prompts_pagination(
        self, test_client, mock_managers, valid_token, sample_user, sample_prompts
    ):
    ...
    def test_list_prompts_category_filter(
        self, test_client, mock_managers, valid_token, sample_user, sample_prompts
    ):
        ...
        mock_managers["auth_manager"].get_tenant_users.return_value = [sample_user]
        mock_managers["data_manager"].get_prompts_by_category.return_value = [
            sample_prompts[0]
        ]
    ...
    def test_list_prompts_search_filter(
        self, test_client, mock_managers, valid_token, sample_user, sample_prompts
    ):
    ...
    def test_list_prompts_exclude_enhancement(
        self, test_client, mock_managers, valid_token, sample_user, sample_prompts
    ):
    ...
    def test_list_prompts_pagination_limits(
        self, test_client, mock_managers, valid_token, sample_user
    ):
        ...
        # Test minimum page
        response = test_client.get(
            "/api/prompts?page=0", headers={"Authorization": f"Bearer {valid_token}"}
        )
    ...
    def test_get_prompt_by_id(
        ...
        response = test_client.get(
            "/api/prompts/1", headers={"Authorization": f"Bearer {valid_token}"}
        )
    ...
    def test_get_prompt_by_id_not_found(
        ...
        response = test_client.get(
            "/api/prompts/999", headers={"Authorization": f"Bearer {valid_token}"}
        )
    ...
    def test_get_prompt_by_name(
        ...
        mock_managers["auth_manager"].get_tenant_users.return_value = [sample_user]
        mock_managers["data_manager"].get_prompt_by_name.return_value = sample_prompts[
            0
        ]
    ...
    def test_get_prompt_by_name_not_found(
        self, test_client, mock_managers, valid_token, sample_user
    ):
    ...
    def test_list_categories(
        ...
        mock_managers["auth_manager"].get_tenant_users.return_value = [sample_user]
        mock_managers["data_manager"].get_categories.return_value = [
            "Testing",
            "Development",
            "Production",
        ]
        ...
        response = test_client.get(
            "/api/categories", headers={"Authorization": f"Bearer {valid_token}"}
        )
    ...
    def test_search_prompts(
        ...
        response = test_client.get(
            "/api/search?q=test", headers={"Authorization": f"Bearer {valid_token}"}
        )
    ...
    def test_search_prompts_missing_query(
        self, test_client, mock_managers, valid_token, sample_user
    ):
        ...
        response = test_client.get(
            "/api/search", headers={"Authorization": f"Bearer {valid_token}"}
        )
    ...
    def test_get_stats(
        ...
        mock_managers["auth_manager"].get_tenant_users.return_value = [sample_user]
        mock_managers["data_manager"].get_all_prompts.return_value = sample_prompts
        mock_managers["data_manager"].get_enhancement_prompts.return_value = [
            sample_prompts[1]
        ]  # Enhancement prompt
        mock_managers["data_manager"].get_categories.return_value = [
            "Testing",
        ...
        response = test_client.get(
            "/api/stats", headers={"Authorization": f"Bearer {valid_token}"}
        )
    ...
    def test_error_handling_database_error(
        self, test_client, mock_managers, valid_token, sample_user
    ):
        ...
        mock_managers["auth_manager"].get_tenant_users.return_value = [sample_user]
        mock_managers["data_manager"].get_all_prompts.side_effect = Exception(
            "Database error"
        )
        ...
        try:
            ...
            assert (
                False
            ), f"Expected exception to be raised, got status {response.status_code}"
    ...
    def test_authentication_header_variations(
        self, test_client, mock_managers, sample_user
    ):
        ...
        response = test_client.get(
            "/api/prompts", headers={"Authorization": "Bearer valid-token"}
        )
        assert response.status_code == 200
    ...
    def test_url_encoding_in_names(
        ...
        # The expected decoded name is "test prompt with spaces"
    ...
    def test_concurrent_requests_safety(
        self, test_client, mock_managers, valid_token, sample_user
    ):
