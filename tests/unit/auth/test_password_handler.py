...
class TestPasswordHandler:
    ...
    def test_password_handler_initialization_bcrypt(self):
        ...
        with patch('src.auth.security.password_handler.ARGON2_AVAILABLE', False), \
    ...
    def test_verify_password_empty_inputs(self):
        ...
        # None inputs
        assert handler.verify_password(None, "hash", "salt") is False
        assert handler.verify_password("password", None, "salt") is False
    ...
    def test_hash_password_argon2(self):
        ...
        with patch('src.auth.security.password_handler.PasswordHasher', return_value=mock_hasher):
    ...
    def test_verify_password_argon2(self):
        ...
        mock_hasher = MagicMock()
        mock_hasher.verify.return_value = None  # Argon2 verify doesn't return, just raises on failure
    ...
    def test_hash_password_exception_handling(self):
        ...
        with patch('src.auth.security.password_handler.hashlib.pbkdf2_hmac', side_effect=Exception("Hash failed")):
            with pytest.raises(AuthenticationException) as exc_info:
    ...
    def test_verify_password_exception_handling(self):
        ...
        with patch('src.auth.security.password_handler.hashlib.pbkdf2_hmac', side_effect=Exception("Verify failed")):
