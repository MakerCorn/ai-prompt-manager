...
from language_manager import LanguageManager, get_language_manager, t, set_language, get_available_languages
...
class TestLanguageManager:
    ...
    @pytest.fixture
    def language_manager(self, temp_languages_dir, sample_english_data, sample_french_data):
        ...
        return LanguageManager(languages_dir=str(temp_languages_dir), default_language="en")

    def test_initialization(self, temp_languages_dir):
        """Test LanguageManager initialization"""
        manager = LanguageManager(languages_dir=str(temp_languages_dir), default_language="en")
    ...
    def test_get_nested_value_simple(self, language_manager):
        ...
        # Nested key
        result = language_manager._get_nested_value(translations, "app.status.authenticated")
