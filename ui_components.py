...
class UIComponents:
    ...
    @staticmethod
    def create_header(
        title_key: str, subtitle_key: Optional[str] = None
    ) -> gr.Markdown:
    ...
    @staticmethod
    def create_card(
        content: Union[str, gr.Component], title: Optional[str] = None
    ) -> gr.Column:
        """Create a card-like container"""
        with gr.Column(
            elem_classes=["ui-card"], elem_id="card", variant="panel"
        ) as card:
            if title:
    ...
    def create_input_group(
        ...
        **kwargs,
        ...
        if input_type == "text":
            ...
            return gr.Textbox(
                label=label, placeholder=placeholder, elem_classes=css_classes, **kwargs
            )
            ...
            if extra_classes:
                css_classes.extend(extra_classes)
            return gr.Dropdown(label=label, elem_classes=css_classes, **kwargs)
        elif input_type == "number":
            css_classes = ["modern-input"]
            if extra_classes:
                css_classes.extend(extra_classes)
            return gr.Number(label=label, elem_classes=css_classes, **kwargs)
    ...
    def create_button(
        ...
        **kwargs,
        ...
        return gr.Button(label, variant=variant, elem_classes=css_classes, **kwargs)

    @staticmethod
    def create_status_display(
        label_key: str, status_type: str = "info", **kwargs
    ) -> gr.Textbox:
        ...
        return gr.Textbox(
            label=label, interactive=False, elem_classes=css_classes, **kwargs
        )
    ...
    def create_responsive_layout(
        left_content_fn, right_content_fn, left_scale: int = 2, right_scale: int = 1
    ) -> gr.Row:
    ...
    def create_search_bar(
        placeholder_key: str = "form.placeholder.search", with_filters: bool = True
    ...
    def create_prompt_card(
        prompt_data: Dict[str, Any], selectable: bool = True
    ) -> gr.HTML:
        ...
        card_class = (
            "enhancement-prompt-card" if is_enhancement else "regular-prompt-card"
        )
    ...
    def create_drop_zone(
        zone_type: str = "add", message_key: str = "builder.drag.add"
    ) -> gr.HTML:
