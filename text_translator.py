...
class TextTranslator:
    ...
    def translate_to_english(self, text: str, source_language: str = None) -> Tuple[bool, str, str]:
        """
        ...
        for service in services_to_try:
            if service in self.translation_services:
                try:
                    success, translated_text, error = self.translation_services[service](
    ...
    def _translate_with_openai(self, text: str, source_language: str) -> Tuple[bool, str, str]:
...
{text}"""
    ...
    def _translate_with_google(self, text: str, source_language: str) -> Tuple[bool, str, str]:
    ...
    def _translate_with_libre(self, text: str, source_language: str) -> Tuple[bool, str, str]:
    ...
    def _translate_with_mock(self, text: str, source_language: str) -> Tuple[bool, str, str]:
